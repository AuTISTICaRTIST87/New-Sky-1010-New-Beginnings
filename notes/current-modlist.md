...
Generated from the clean `Late Diagnosed 1010 New Beginnings` profile on 2026-05-03.
...
- AdvancedReborn-1.21.1-1.3.4.jar
- AmbientSounds_FABRIC_v6.3.6_mc1.21.1.jar
- animated-mojang-logo-2.1.jar
- appleskin-fabric-mc1.21-3.0.6.jar
- architectury-13.0.8-fabric.jar
- balm-fabric-1.21.1-21.0.57.jar
- blur-fabric-6.2.0+1.21.1.jar
- bountifulfares-fabric-1.21.1-3.0.7.jar
- chat_heads-0.15.1-fabric-1.21.jar
- classicpipes-fabric-1.21.1-1.1.3.jar
- cloth-config-15.0.140-fabric.jar
- collective-1.21.1-8.22.jar
- continuity-3.0.0+1.21.jar
- Controlling-fabric-1.21.1-19.0.5.jar
- CreativeCore_FABRIC_v2.13.37_mc1.21.1.jar
- croptopia-refabricated-0.1.0+1.21.1.jar
- dynamic-fps-3.11.4+minecraft-1.21.0-fabric.jar
- energizedpower-1.21.1-2.15.20-fabric.jar
...
- flowermimics-1.21.1-2.1.jar
- foodpouch-1.21.1-fabric-0.1.2-alpha.jar
- ForgeConfigAPIPort-v21.1.6-1.21.1-Fabric.jar
- heywiki-fabric-1.7.7+1.21.1.jar
- immersive_furniture-fabric-0.1.3+1.21.1.jar
- IndustrialRevolution-mahiro76-1.21.1-beta-1.0.jar
- iris-fabric-1.8.8+mc1.21.1.jar
- itemalchemy-1.3.0.jar
- Jade-1.21.1-Fabric-15.10.5.jar
- jei-1.21.1-fabric-19.27.0.340.jar
- journeymap-fabric-1.21.1-6.0.0-beta.66.jar
